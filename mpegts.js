...
(function() {
  ...
  api = {
    open: function(file) {
      return tsBuf = fs.readFileSync(file); // up to 1GB
    },
    close: function() {
      return tsBuf = null;
    },
    ...
    startStreaming: function(initialSkipTimeMs = 0) {
      this.resetState();
    ...
    consumeVideo: function(doNotReadNext = false) {
    ...
    consumeAudio: function(doNotReadNext = false) {
      var pendingLen, pesInfo, timeDiff;
    ...
    queueVideo: function(pesInfo, doNotReadNext = false) {
      var timeDiff;
    ...
    queueAudio: function(pesInfo, doNotReadNext = false) {
      var timeDiff;
    ...
    readNext: function() {
      ...
      if (pesInfo.program_map != null) {
        ...
        this.consumeUnparsedPESPackets(); // received a program map
      }
    ...
    read_descriptor: function(bits) {
      ...
      info = (function() {
        switch (descriptor_tag) {
          ...
          case 0x48:
            return api.read_DVB_service_descriptor(bits); // 72
          case 0x52:
            return api.read_DVB_stream_identifier_descriptor(bits); // 82
          case 193:
          case 200:
          case 246:
          case 253:
