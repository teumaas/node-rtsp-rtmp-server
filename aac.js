    ...
    splitIntoADTSFrames: function(buffer) {
      ...
      while (true) {
        ...
        if (buffer.length >= aac_frame_length + 2) {
          // check next syncword
          if ((buffer[aac_frame_length] !== 0xff) || (buffer[aac_frame_length + 1] & 0xf0 !== 0xf0)) { // false syncword
    ...
    feedPESPacket: function(pesPacket) {
      ...
      while (true) {
        ...
        if (audioBuf.length >= aac_frame_length + 2) {
          // check next syncword
          if ((audioBuf[aac_frame_length] !== 0xff) || (audioBuf[aac_frame_length + 1] & 0xf0 !== 0xf0)) { // false syncword
